...
class TestHashPassword:
    ...
    def test_generates_hashed_password_for_verification(self):
        password = "securepassword123"
        hashed_password = Admin.hash_password(password)
        assert check_password_hash(hashed_password, password)

    def test_consistent_hashing_different_formats(self):
        password1 = "securepassword123"
        password2 = "securepassword123 "
        hashed_password_1 = Admin.hash_password(password1)
        hashed_password_2 = Admin.hash_password(password2)
        assert hashed_password_1 == hashed_password_2
